...
const updateIncoterms = () => {
    ...
    /*Control de errores: Si el valor del campo código supera más de 5 carácteres
    no dejará guardar los datos en la app (incluida en la BD)*/

    //Reset del error (cada vez que haga un insert en la BD)
    esError.value = false;
    mensajeError.value = '';
