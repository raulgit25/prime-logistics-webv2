...
import ModalUpdateIncotermComponent from './components/tiposIncoterm/ModalUpdateIncotermComponent.vue';
...
app.component('modal-update-incoterm-component', ModalUpdateIncotermComponent);
app.mount('#app');